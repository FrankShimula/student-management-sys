    ...
    <div id="sticker">
      ...
      <div class="menu">
        ...
        <ul>
            ...
            <li><a href="student.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
            <li><a href="st_profile.php"><i class="fa fa-home" aria-hidden="true"></i>Profile</a></li>
            <li><a href="studentnotifications.php"><i class="fa fa-home" aria-hidden="true"></i>Announcements</a></li>
