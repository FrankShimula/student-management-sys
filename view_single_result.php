...
<div class="all_student fix">
	...
	<!--Infomation of student-->
		<div>
	<p style="text-align:center;color:#fff;background:#1abc9c;margin:0;padding:8px;"><?php echo "Name: ".$sname."<br>Student ID: " . $sid; ?></p>
	</div>
	<br>
	<form action="" method="post" style="width: 25%; margin: 0 auto; padding-bottom: 5px;">
		<select name="seme" id="" style="width: 100%; padding: 8px; font-size: 14px; border-radius: 5px; margin-bottom: 10px; background-color: #1abc9c; color: #fff; border: none;">
	  <option value="1st">1st Semester</option>
	  <option value="2nd">2nd Semester</option>
	  <option value="3rd">3rd Semester</option>
	</select>

  <input type="submit" value="View Result" style="width: 100%; padding: 10px; font-size: 14px; background-color: #1abc9c; color: #fff; border: none; border-radius: 5px; cursor: pointer;">
</form>
<br>
	<br>
	<?php
	//select semester
			...
			$gp = 0;
				...
				$get_result = $user->show_marks($sid,$semester);
				if($get_result){
			?>
		...
		?>
		<div class="fix">
		<p style="float:left;margin:0 0 3px 0;width:100%;text-align:center;"><a href="view_single_cgpa.php?vr=<?php echo $sid; ?>&vn=<?php echo $sname; ?>"><button class="editbtn">View CGPA & Complete results</button></a></p>
		</div>
