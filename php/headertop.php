...
<html class="no-js" lang="">
    ...
    <body>
        <header class="container header_area" >
            ...
            <li><a href="stuattview.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Attendance</a></li>
            <li><a href="stutimetableview.php"><i class="fa fa-calendar" aria-hidden="true"></i>Timetable</a></li>
