    ...
    <div id="sticker">
      ...
      <div class="menu">
        ...
        <ul>
            ...
            <li><a href="facultyindex.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
            <li><a href="facultynotification.php"><i class="fa fa-bell" aria-hidden="true"></i> Announcements</a></li>
